...
class RegisterActivity : AppCompatActivity() {
    ...
    private var tranIdentificationCard: EditText? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerSigninBtn.setOnClickListener { startActivity(Intent(this@RegisterActivity, LoginActivity::class.java)) }
    }
    ...
    private fun initialise() {
        ...
        tranIdentificationCard = findViewById<View>(R.id.registerIdentificationcard) as EditText
    ...
    private fun createNewAccount(){
        ...
        identificationCard = tranIdentificationCard?.text.toString()
